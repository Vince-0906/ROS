...
tags:
  ...
  - 实战
---
⬅️ **上一节**：[9.5.5 完成机器人建图并保存地图](9.5.5%20完成机器人建图并保存地图.md)

> 📂 **配套代码**：[`999/ws/src/szcbot_navigation2/launch/navigation2.launch.py`](../../999/ws/src/szcbot_navigation2/launch/navigation2.launch.py) · [`999/ws/src/szcbot_navigation2/config/nav2_params.yaml`](../../999/ws/src/szcbot_navigation2/config/nav2_params.yaml)

# szcbot_navigation2
## 创建功能包
```bash
ros2 pkg create szcbot_navigation2
```
...
```
## nav2_params.yaml
路径在`/opt/ros/$ROS_DISTRO/share/nav2_bringup/params`，记得修改参数
```yaml
amcl:
  ros__parameters:
    alpha1: 0.2
...
# 运行
```bash
ros2 launch szcbot_bringup bringup.launch.py
```

```bash
ros2 launch szcbot_navigation2 navigation2.launch.py
```

---

➡️ **下一节**：[10.1.1 QoS策略](10.1.1%20QoS策略.md)　·　📑 [返回笔记索引](../../README.md#笔记索引)
