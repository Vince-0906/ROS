...
tags:
  ...
  - ROS2
---
⬅️ **上一节**：[5.2.1 从机械臂底座到相机的静态TF发布](5.2.1%20从机械臂底座到相机的静态TF发布.md)

> 📂 **配套代码**：[`555/ws/src/demo_py_tf/demo_py_tf/dynamic_tf_broadcaster.py`](../../555/ws/src/demo_py_tf/demo_py_tf/dynamic_tf_broadcaster.py)
...
```
注意，动态的TF会有At time，而静态是0

---

➡️ **下一节**：[5.2.3 通过Python查询TF关系](5.2.3%20通过Python查询TF关系.md)　·　📑 [返回笔记索引](../../README.md#笔记索引)
