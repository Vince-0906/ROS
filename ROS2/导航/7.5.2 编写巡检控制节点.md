...
tags:
  ...
  - 导航
---
⬅️ **上一节**：[7.4.4 使用接口完成路点导航](7.4.4%20使用接口完成路点导航.md)

> 📂 **配套代码**：[`777/ws/src/autopartol_robot/autopartol_robot/partol_node.py`](../../777/ws/src/autopartol_robot/autopartol_robot/partol_node.py) · [`777/ws/src/autopartol_robot/config/partol_config.yaml`](../../777/ws/src/autopartol_robot/config/partol_config.yaml) · [`777/ws/src/autopartol_robot/launch/autopatrol.launch.py`](../../777/ws/src/autopartol_robot/launch/autopatrol.launch.py)

# 创建节点
```bash
ros2 pkg create autopartol_robot --build-type ament_python --dependencies rclpy nav2_simple_commander --license Apache-2.0
```
# partol_node.py代码
```python
...
# 导出数据
```bash
ros2 param dump /partol_robot
```
# partol_config.yaml配置
```yaml
/partol_robot:
  ros__parameters:
...
# 用文件启动
```bash
 ros2 run autopartol_robot partol_node --ros-args --params-file /home/szc/ROS/777/ws/install/autopartol_robot/share/autopartol_robot/config/partol_config.yaml
```

---

➡️ **下一节**：[7.5.3 添加语音播报功能](7.5.3%20添加语音播报功能.md)　·　📑 [返回笔记索引](../../README.md#笔记索引)
